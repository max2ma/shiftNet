...
#include "p1_0"
		...
		MulChan::_shift<DataType, DIM_0, 1, 1, C, 1, CHAN_0>(tensor, s_act0, D0 ,p0_0,p1_0);
...
#include "p1_1"
		...
		MulChan::_shift<DataType, DIM_0, 1, 1, CHAN_0, 1, CHAN_0>(s_act0, s_act1, D1 ,p0_1,p1_1);
...
#include "p1_2"
		...
		MulChan::_shift<DataType, DIM_0, 1, 1, CHAN_0, 1, CHAN_0>(s_act1, s_act2, D2 ,p0_2,p1_2);
...
#include "p1_3"
		...
		MulChan::_shift<DataType, DIM_0, 1, 2, CHAN_0, 1, CHAN_1>(s_act2, s_act3, D3 ,p0_3,p1_3);
		//BLOCK 4
		const int D4[CHAN_1]={
#include "d_4"
		};
...
#include "p1_4"
		...
		MulChan::_shift<DataType, DIM_1, 1, 1, CHAN_1, 1, CHAN_1>(s_act3, s_act4, D4 ,p0_4,p1_4);
		//BLOCK 5
		const int D5[CHAN_1]={
#include "d_5"
		};
...
#include "p1_5"
		...
		MulChan::_shift<DataType, DIM_1, 1, 1, CHAN_1, 1, CHAN_1>(s_act4, s_act5, D5 ,p0_5,p1_5);
		//GROUP 3
...
#include "p1_6"
		...
		MulChan::_shift<DataType, DIM_1, 1, 2, CHAN_1, 1, CHAN_2>(s_act5, s_act6, D6 ,p0_6,p1_6);
		//BLOCK 7
		const int D7[CHAN_2]={
#include "d_7"
		};
...
#include "p1_7"
		...
		MulChan::_shift<DataType, DIM_2, 1, 1, CHAN_2, 1, CHAN_2>(s_act6, s_act7, D7 ,p0_7,p1_7);
		//BLOCK 8
		const int D8[CHAN_2]={
#include "d_8"
		};
...
#include "p1_8"
		...
		MulChan::_shift<DataType, DIM_2, 1, 1, CHAN_2, 1, CHAN_2>(s_act7, s_act8, D8 ,p0_8,p1_8);
...
#include "p_9"
		...
		MulChan::_matMul<DataType, DIM_2, CHAN_2, N>(s_act8, s_fc, p_9);
